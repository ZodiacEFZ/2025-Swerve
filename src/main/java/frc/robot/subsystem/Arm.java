...
public class Arm extends SubsystemBase {
    ...
    /**
     * The position of the arm installed on the robot.
     * The x component is the distance from the front of the robot to the axis of the first stage of the arm,
     * viewing from the left side of the robot.
    ...
    /**
     * The position limit of the arm's components.
     * The x component is the distance from the front of the robot to the axis of the first stage of the arm,
     * viewing from the left side of the robot.
     * The y component is the height of the first stage of the arm.
     */
    ...
    private Translation2d getStage2Position() {
        return this.getStage1Position().plus(new Translation2d(this.forearmLength.times(Math.cos(this.getStage2Angle().in(Units.Radians))),
    ...
    /**
     * Calculates the angles of the stages of the arm with the given position.
     * The first element of the pair is the angle of the first stage.
     * The second element of the pair is the angle of the second stage.
     *
...
//        double theta2 = theta0 - theta1 + delta2;
        ...
        theta1 = Math.atan2(stage2Position.getY(), stage2Position.getX()) - Math.atan2(l2 * sinTheta2, l1 + l2 * cosTheta2);
        return new Pair<>(Units.Radians.of(theta1), Units.Radians.of(theta2));
    }
